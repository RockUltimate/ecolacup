                    ...
                    <section class="space-y-4">
                        ...
                        <div class="space-y-4">
                            @foreach($items as $prihlaska)
                                ...
                                <div onclick="window.location='{{ route('prihlasky.show', $prihlaska) }}'" class="panel p-6 cursor-pointer transition hover:shadow-md">
                                    <div class="flex items-start justify-between gap-4">
                                        ...
                                        <div class="shrink-0">
                                            <a href="{{ route('prihlasky.pdf', $prihlaska) }}" class="button-secondary" onclick="event.stopPropagation()">PDF</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
