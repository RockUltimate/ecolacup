    ...
    public function run(): void
    {
        ...
        $kone = [
            [
                ...
                'ehv_datum' => '2027-09-12',
                'aie_datum' => '2026-07-16',
                'chripka_datum' => '2026-05-03',
        ...
        foreach ($kone as $kun) {
            ...
            Kun::query()->updateOrCreate(
                ...
                [
                    ...
                    'staj' => $kun['staj'],
                    'pohlavi' => $kun['pohlavi'],
                    'ehv_datum' => $kun['ehv_datum'] ?? null,
                    'aie_datum' => $kun['aie_datum'] ?? null,
                    'chripka_datum' => $kun['chripka_datum'] ?? null,
